import { CheckCircleRounded, Inventory2Rounded, LinkRounded, TaskAltRounded, VerifiedUserRounded } from '@mui/icons-material'
...
export function FloatingActivityCards({ variant, activeKind }: { variant: AuthVisualVariant; activeKind: PhoneScreenKind }) {
  ...
  return <>
    ...
    <div className={`float-card float-card--rotating float-card--stock${activeKind === 'stock' ? ' is-active' : ''}`}><Inventory2Rounded /><span><small>Stock actualizado</small><b>Repuesto descontado automáticamente</b></span></div>
  </>
}
