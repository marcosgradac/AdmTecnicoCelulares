export function CustomerTrackingPreview() {
  return <div className="showcase-screen showcase-tracking">
    ...
    <div className="showcase-message">Estamos trabajando en tu equipo. Próximamente pasará a control de calidad.</div>
    <div className="showcase-money"><span><small>Presupuesto</small><b>$180.000</b></span><span><small>Pendiente</small><b>$100.000</b></span></div>
  </div>
}
