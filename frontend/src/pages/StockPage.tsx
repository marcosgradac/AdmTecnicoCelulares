...
export function StockPage() {
  const { user } = useAuth()
  const canAdminister = canAccess(user, 'stock:admin')
  ...
  return <Box>
    <PageHeader eyebrow="INVENTARIO" title="Stock de repuestos" description="Controlá existencias, costos y precios de venta." action={canAdminister ? <Button variant="contained" startIcon={<AddRounded />} onClick={startCreate}>Nuevo repuesto</Button> : undefined} />
