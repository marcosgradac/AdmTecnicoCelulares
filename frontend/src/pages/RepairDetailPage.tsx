...
import { getRepair, updateRepair, updateRepairStatus, deleteRepair, type UpdateRepairInput } from '../services/repairs'
import { getClientOptions, registerPayment, type ClientOption } from '../services/operations'
import { useAuth } from '../auth/AuthContext'
import { canAccess } from '../auth/permissions'
import { CurrencyField } from '../components/common/CurrencyField'
import { cancellationReviewBalance } from '../types'
...
export function RepairDetailPage() {
  ...
  for (const item of repair.history ?? []) {
    ...
    historyEvents.push({ id: item.id ?? `${item.createdAt}-${item.newStatus}`, date: item.createdAt, label: `Estado: ${repairStatusConfig[item.newStatus].label}` })
  }
