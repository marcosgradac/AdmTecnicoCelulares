...
import { FilterBar, FormSection, ListPagination } from '../components/admin/AdminPatterns'
import { CommerceCatalog } from '../components/admin/CommerceCatalog'
import { CommerceSalesList } from '../components/admin/CommerceSalesList'
...
import { Alert, Box, Button, Card, CardContent, Chip, Grid, IconButton, MenuItem, Stack, TextField, Typography } from '@mui/material'
import { useNavigate } from 'react-router-dom'
import { useAuth } from '../auth/AuthContext'
import { canAccess } from '../auth/permissions'
import { useSubscription } from '../features/billing/SubscriptionContext'
import { createCommerceCategory, createCommerceExpense, createCommerceProduct, createCommerceSale, deleteCommerceCategory, deleteCommerceProduct, getCommerceCategories, getCommerceProducts, getCommerceSales, getCommerceSummary, updateCommerceProduct, updateCommerceCategory, type CommerceCategory, type CommercePaymentMethod, type CommerceProduct, type CommerceSale, type CommerceSummary } from '../services/commerce'
...
export function CommercePageV2() {
  ...
  const [products, setProducts] = useState<CommerceProduct[]>([]), [categories, setCategories] = useState<CommerceCategory[]>([]), [summary, setSummary] = useState<CommerceSummary | null>(null), [sales, setSales] = useState<CommerceSale[]>([])
