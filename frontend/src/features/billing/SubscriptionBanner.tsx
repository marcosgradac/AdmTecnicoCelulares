...
export function SubscriptionBanner() {
  ...
  if (!subscription || (subscription.status === 'ACTIVE' && subscription.daysRemaining > 7 && !subscription.pendingPayment)) return null
  ...
  const copy = subscription.status === 'SUSPENDED'
