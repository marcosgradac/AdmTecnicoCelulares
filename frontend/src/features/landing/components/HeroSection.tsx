...
import { ArrowForwardRounded, AutoAwesomeRounded, KeyboardArrowDownRounded } from '@mui/icons-material'
  ...
  return <section className="landing-hero premium-hero" aria-labelledby="hero-title">
    ...
    <div className="landing-container hero-content hero-grid">
      <div className="hero-copy">
        ...
        <div className="hero-actions"><Button component={Link} to={user?'/admin':'/registro'} size="large" variant="contained" endIcon={<ArrowForwardRounded/>}>{user?'Ir al panel':'Empezar gratis'}</Button><Button className="hero-secondary-action" component="a" href="#funciones" size="large" variant="text" startIcon={<KeyboardArrowDownRounded/>}>Ver funciones</Button></div>
